...
<div class="bg-black" id="sidebar-wrapper" style="display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="list-group list-group-flush my-3 ">
        <a href="/dashoverview" class="list-group-item list-group-item-action bg-transparent second-text {{ Route::is('dashoverview') ? 'active' : '' }}">
            <img src="https://i.ibb.co/qyGCP5v/dashboard-Copy.png" width="30" style="margin-right: 30px" class="white-image">
            Overview
        </a>
        <a href="/dashorders" class="list-group-item list-group-item-action bg-transparent second-text {{ Route::is('dashorders') ? 'active' : '' }}">
            <img src="https://i.ibb.co/YWYRLz1/clipboard-Copy.png" width="30" style="margin-right: 30px" class="white-image">
            Orders
        </a>
        <a href="/dashshipment" class="list-group-item list-group-item-action bg-transparent second-text {{ Route::is('dashshipment') ? 'active' : '' }}">
            <img src="https://i.ibb.co/562hzDZ/delivery-Copy.png" width="30" style="margin-right: 30px" class="white-image">
            Shipment
            
        </a>
        <a href="/dashclient" class="list-group-item list-group-item-action bg-transparent second-text {{ Route::is('dashclient') ? 'active' : '' }}">
