                                ...
                                <form class="text-white">
                                    ...
                                    <div class="mb-4" style="margin-bottom: 10px;">
                                        <div class="d-flex flex-row">
                                            <button type="button" class="btn btn-success btn-lg gradient-custom-4 text-body" style="background-color: #2E2E2E; flex: 1; margin-right: 4px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #000; color: white !important;">Cancel</button>
                                            <button type="button" class="btn btn-success btn-lg gradient-custom-4 text-body" style="background-color: #2E2E2E; flex: 1; margin-left: 4px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #000; color: white !important;">Submit</button>
                                        </div>
                                    </div>
