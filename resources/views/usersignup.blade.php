                            ...
                            <div class="card-body p-5">
                                <form class="text-white">
                                    ...
                                    <div class="d-flex justify-content-center mb-4">
                                      <button type="submit" class="btn btn-success btn-lg gradient-custom-4 text-body" style="background-color: #2E2E2E; width: 100%; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #000; color: white !important;">Sign Up</button>
